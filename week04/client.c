...
void setup_tcp_communication() {
    ...
    while(1) {
	    ...
	    scanf("%s", &client_data.first_name);
        printf("Enter second name : ?\n");
	    scanf("%s", &client_data.second_name);
	    printf("Enter age : ?\n");
	    ...
	    sent_recv_bytes =  recvfrom(sockfd, (char *)&result, sizeof(student_result_struct_t), 0,
